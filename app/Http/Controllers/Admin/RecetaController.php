...
class RecetaController extends Controller
{
    ...
    public function getPacientes(Request $request)
    {
        ...
        // Buscar pacientes por cédula o por nombres
        if (!empty($search)) {
        ...
        $pacientes = $query->orderBy('nombre')->limit(5)->get();
        ...
        foreach ($pacientes as $paciente) {
            ...
            // Formatear el resultado para Select2
            $response[] = [
                'id' => $paciente->id,
                'text' => $nombreCompleto . ($cedula ? " - $cedula" : ""),
            ];
        }

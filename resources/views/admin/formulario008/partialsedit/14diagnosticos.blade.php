        ...
        <tr>
            <td style="width: 50%;">
                ...
                <table class="table table-bordered mt-3" id="diagnosticoscie10_table">
                    ...
                    <tbody>
                        {{-- Aquí se mostrarán los diagnósticos presuntivos --}}
                        ...
                        <tr>
                            <td>                        
                                <select name="diagnosticos_presuntivos[]" class="form-control select2cie10">
                                    <option value="{{ $diagnostico->id }}" selected>
                                        {{ $diagnostico->descripcion }} ({{ $diagnostico->clave }})
                                    </option>
                                    {{-- Opciones restantes --}}
                                    @foreach ($diagnosticoscie10s as $diagnosticoscie10)
                                        @if ($diagnostico->id != $diagnosticoscie10->id)
                            ...
                            <td style="font-size: 12px">
                                <input class="form-control diagnosticocie10-clave" type="text" name="diagnosticocie10_generico_3" value="{{ $diagnostico->clave }}" readonly>
                            </td>
                            <td>
            ...
            <td style="width: 50%;">
                ...
                <table class="table table-bordered mt-3" id="diagnosticoscie10f_table">
                    ...
                    <tbody>
                        {{-- Aquí se mostrarán los diagnósticos definitivos --}}
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px">
                                <input class="form-control diagnosticocie10f-clave" type="text" name="diagnosticocie10f_generico_3" value="{{ $diagnostico->clave }}" readonly>
                            </td>
                            <td>

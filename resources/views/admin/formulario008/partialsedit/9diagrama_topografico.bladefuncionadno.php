        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            contenedor.addEventListener("dblclick", function (event) {
                ...
                if (lesionId !== null) {
                    ...
                    numeroDiv.setAttribute("data-lesion", lesionId);
                    numeroDiv.style.left = x + "px";
                    numeroDiv.style.top = y + "px";
                    numerosContainer.appendChild(numeroDiv);

                    // Permitir múltiples selecciones de la misma lesión
                    numeroDiv.addEventListener("click", function () {
                        if (isSelecting) {
                            let copiaNumeroDiv = numeroDiv.cloneNode(true);
                            numerosContainer.appendChild(copiaNumeroDiv);
                        }
                    });

<div class="form-group">
    ...
    <div style="display: flex;">
        ...
        <div class="contenedor" id="contenedor-imagen" style="flex: 1;">
            ...
            <span class="tooltip-text">Doble clic para agregar número de lesión</span>
        </div>
        ...
        <div id="table-container" style="flex: 2;">
            <table border="1" cellspacing="-5" cellpadding="3" width="100%">
                ...
                <tbody>   
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-check-input lesion-checkbox" style="margin-left: 40px" type="checkbox" id="lesion{{ $lesion->id }}"
                                name="lesiones[{{ $lesion->id }}][id]" value="{{ $lesion->id }}" data-coord-x="{{ $lesion->posicion_x }}" data-coord-y="{{ $lesion->posicion_y }}">
                        </td>
            ...
            <button id="guardar-btn" type="button" class="btn btn-primary mt-3">Guardar</button>
        </div>
    </div>
    
    <input type="hidden" id="lesiones-seleccionadas" name="lesiones" value="">

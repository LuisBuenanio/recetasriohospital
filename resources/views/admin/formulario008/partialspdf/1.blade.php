                            ...
                            <tr>
                                ...
                                <td style="width: 50%;">
                                    ...
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">1</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">HERIDA PENETRANTE</th>
                                                <td></td>
                                             ...
                                             --}}</tr>
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">2</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">HERIDA NO PENETRANTE</th>
                                                <td></td>
                                                {{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                            --}} </tr>
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">3</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">FRACTURA EXPUESTA</th>
                                                <td></td>
                                                {{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                           --}}  </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">4</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">FRACTURA CERRADA</th>
                                                <td></td>
                                               {{--  <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                            --}} </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">5</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">AMPUTACIÓN</th>
                                                <td></td>
                                                {{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                            --}} </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">6</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">HEMORRAGIA</th>
                                                <td></td>
                                               {{--  <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                           --}}  </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">7</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">MORDEDURA</th>
                                           ...
                                           --}}  </tr>
                                            ...
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">8</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">PICADURA</th>
                                                <td></td>{{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                            --}} </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">9</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">EXCORIACIÓN</th>
                                               <td></td>{{--  <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                           --}}  </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">10</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">DEFORMIDAD O MASA</th>
                                               <td></td> {{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                            --}} </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">11</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">HEMATOMA</th>
                                               <td></td>{{--  <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                           --}}  </tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">12</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">QUEMADURA G I</th>
                                                <td></td>{{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                             --}}</tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">13</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">QUEMADURA G II</th>
                                                <td></td>{{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                             --}}</tr>
                                            
                                            <tr>
                                                <td style="font-size: 5px; padding: 2px; vertical-align: middle;">14</td>
                                                <th style="font-size: 5px; padding: 2px; vertical-align: middle;">QUEMADURA G III</th>
                                                <td></td>{{-- <td style="padding: 2px; vertical-align: middle;"><input style="transform: scale(0.5); display: inline-block;" type="checkbox" {{ $formulario008->r_cabeza == 'CP' ? 'checked' : '' }}/></td>
                                           --}}  </tr>
